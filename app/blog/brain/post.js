...
export default function BrainPost() {
    ...
    >
      {language === "English" ? (
        <>
          ...
          <div className="mb-2">
            I&apos;d say it&apos;s missing something. Something essential. That
            art is for human being.
          </div>
          <div className="mb-2">
            I planned to write about whether art is objective or subjective. But
            hey, I&apos;m no philosopher. I&apos;ll just pop a question here.
            Suppose there is art existing somewhere in the universe, that no one
            has seen it, no one has heard about it, no one knows about it. Is it
            still art?
          </div>
          <div className="mb-2">
            I don&apos;t have much insights to the answer, still exploring
            myself too. However, here I want to talk about how important art is
            to the brain.
          </div>
          <div className="mb-2">
            I&apos;ve been reading a book, How emotions are made, by Lisa
            Feldman Barrett. It talks about how brain is consuming every
            sensation your body provides, non stop, and then provides prediction
            about outside world and then tells your body to react. I also want
            to mention another study I learned on Ted.com that daily exercise
            can actually improve &quot;brain muscle&quot;.
          </div>
          <div className="mb-2">
          ...
          <div className="mb-2">
            ...
            the message delivered in my art work. After all, art is the carrier
            of information to the brain. And to be connected by information, to
            me, is for us, as a living being, to say confidently that we&apos;re
            not alone.
          </div>
        </>
      ) : (
