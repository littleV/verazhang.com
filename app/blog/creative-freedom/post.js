...
export default function CreativeFreedomPost() {
      ...
      {language === "English" ? (
        <>
          ...
          <div className="mb-2">
            ...
            principles apply to a lot of fields so I&apos;d like to share my
            answers here with a broader audience too.
          </div>
          <div className="ml-6">
            <ul>
              <li>
                ...
                definition of freedom first. My country&apos;s saint, Confucius
                once said &quot;do whatever your heart desires, but do not break
                the rules&quot;. I think it&apos;s one of the best definitions
                of freedom, you can but can not do whatever you want. There is a
                boundary on everything. Once you know the boundary, you can work
                hard to push the boundary a little bit, which will be a break
                through of the art field, and I&apos;d say the biggest creative
                movement.
              </li>
              <li>
                • <strong>Build your own voice.</strong> We learn from our
                ancestors, and gain knowledge from them. However, we must build
                our own voice to speak our own minds.
              </li>
              <li>
                • <strong>Master the skills of your own art field.</strong> Now
                you know your field, you have your own voice, you have to learn
                how to express them. Greatest artists are the ones who both have
                minds and skills.
              </li>
              <li>
                • <strong>Look for cross boundary inspiration.</strong> Staying
                in one field is dangerous sometimes, cause you only get old
                information. New information would inspire new ideas.
              </li>
              <li>
