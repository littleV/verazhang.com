    ...
    <div className="p-2">
      {language === "English" ? (
        <>
          ...
          <div className="mb-2">
            My name is Wei Zhang, and I also go by my Starbucks name, Vera.
            I&apos;m a Shanghai-based contemporary artist creating fine art. I'm
            on my way to my unique aesthetics.
          </div>
          <div className="mb-2">
          ...
          <div className="mb-2">
            ...
            most are usually the things that last. I believe art creates stable
            emotional stories, simple and elegant.
          </div>
          <div className="mb-2">
            I&apos;ve been painting for over 10 years now, moving through
            techniques from professional acrylic to oil to digital. What
            doesn&apos;t change is the beauty of the content — emotions emerge
            the moment a tool brings paint to the surface.
          </div>
        ...
        <div lang="zh">
          ...
          <div className="mb-2">
            我叫章薇，也用我的星巴克名
            Vera。我是一位常驻上海的当代艺术家，从事美术创作。一路探索着自己的艺术路径。
          </div>
          ...
          <div className="mb-2">
            在现代的快节奏中，潮流转瞬即逝。然而，最能打动人的，往往是那些经得起时间考验的东西。我相信，艺术能孕育出稳定的情感故事，简洁而优雅。
          </div>
          <div className="mb-2">
